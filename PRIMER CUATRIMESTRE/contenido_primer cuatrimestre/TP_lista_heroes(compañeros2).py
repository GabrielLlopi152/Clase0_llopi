from lista_heroes import lista_personajes
...
lista_heroes_max_altura = obtener_dato_cantidad(lista_personajes,mayor_altura,'fuerza')'''
...
#stark_imprimir_heroes(lista_heroes_max_altura)
#para ver si retorna false
'''print(stark_imprimir_heroes([]))'''
        ...
        if opcion == "A" and bandera != True:
            ...
            match(opcion):
                case 'B' | 'b':
                    ...
                    generar_json('NB.json', lista_no_binario, 'heroes')
